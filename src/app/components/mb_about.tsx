...
const Mbabout = () => {
  ...
  return (
    ...
    <div id="mbabout" className='md:hidden bg-[#9A3B3B] flex flex-col justify-center items-center mt-12 mb-12 md:mt-[100px] md:mb-[50px] rounded-[50px] md:rounded-[200px] p-4 md:p-0'>
